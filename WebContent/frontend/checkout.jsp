			...
			<div>
				<h2>Review Your Order Details <a href="view_cart">Edit</a></h2>
					...
					<table>
						<tr>
							<td>First Name:</td>
							<td><input typr="text" name="firstname" value="${loggedCustomer.firstname}"></td>
						</tr>
						<tr>
							<td>Last Name:</td>
							<td><input typr="text" name="lastname" value="${loggedCustomer.lastname}"></td>
						</tr>
						<tr>
							<td>Phone:</td>
							<td><input typr="text" name="phone" value="${loggedCustomer.phone}"></td>
						</tr>
						<tr>
							<td>Address Line 1:</td>
							<td><input typr="text" name="address1" value="${loggedCustomer.addressLine1}"></td>
						</tr>
						<tr>
							<td>Address Line 2:</td>
							<td><input typr="text" name="address2" value="${loggedCustomer.addressLine2}"></td>
						</tr>
						<tr>
							<td>City:</td>
							<td><input typr="text" name="city" value="${loggedCustomer.city}"></td>
						</tr>
						<tr>
							<td>State:</td>
							<td><input typr="text" name="state" value="${loggedCustomer.state}"></td>
						</tr>
						<tr>
							<td>Zip Code:</td>
							<td><input typr="text" name="zipcode" value="${loggedCustomer.zipcode}"></td>
						</tr>
						<tr>
							<td>Country:</td>
							<td>
