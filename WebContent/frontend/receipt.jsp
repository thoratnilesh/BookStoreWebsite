				...
				<tr>
					<td colspan="5" align="right">
						<p>
							Subtotal:
							<fmt:formatNumber
								value="${transaction.amount.details.totalAmount}"
								type="currency" />
						</p>
						<p>
							TAx:
						...
						<p>
							Shipping Fee:
							<fmt:formatNumber
								value="${transaction.amount.details.shippingFee}"
								type="currency" />
						</p>
						<p>
							TOTAL:
							<fmt:formatNumber value="${transaction.amount.details.total}"
								type="currency" />
						</p>
					</td>
				</tr>
