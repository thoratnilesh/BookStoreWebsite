...
public class CategoryServices {
	...
	public void creatCategory() throws ServletException, IOException {
	...
	public void updateCategory() throws ServletException, IOException {
		...
		if(categoryByName != null && categoryById.getCategoryId() != categoryByName.getCategoryId()) {
			String message = "Could not update Category. Category with name " + categoryName + " is already exist";
			request.setAttribute("message", message);
	...
	public void deleteCategory() throws ServletException, IOException {
		...
		if(numberOfBooks > 0) {
			message = "Could not delete the categoty (ID: %d) because it contains some books.";
