...
public class PaymentServices {
	private static final String CLIENT_ID = "AZEIARftkTN9obkWiVfq5xRlWstbAomCsRZbcwSQx-cNCqv5FnzNAjWKKeHzJGT_ao2KL43UdTt1KiUa";
	private static final String CLIENT_SECRET = "EItmA3GbZwPulNjYXoQk83IqqWU8oF6Kp4Vb061p3Ipw4Dlk9GoJsA3XfTP7N8kQN59S2JzyA8MZUZcz";
	...
	public void authorizePayment(BookOrder order) throws IOException {
		...
		List<Transaction> transactions = getTransactionInfrmation(order);
	...
	private List<Transaction> getTransactionInfrmation(BookOrder order) {
	...
	public void reviewPayment() throws ServletException, IOException {
		...
		if(paymentId == null || payerId == null) {
			throw new ServerException("Error in displaying payment review");
		}
		...
		try {
			...
			e.printStackTrace();
			throw new ServerException("Error in getting payment details from PayPal.");
		}
	}
