	...
	public class BookServices {
		...
		public void createBook() throws ServletException, IOException  {
			...
			Book newBook = new Book();                          //create readBookField() and call all the values here
		...
		public void readBookFields(Book book) throws ServletException, IOException {
			...
			try {
				...
				ex.printStackTrace();
				throw new ServletException("Error passing publish date (format is MM/DD/YYYY)");
			}
		...
		public void updateBook() throws ServletException, IOException {
			...
			//Book bookByTitle = bookDAO.get(title);
			 
			/*if(bookByTitle != null && !existbook.equals(bookByTitle)) { 
				String message ="Could not update book beacause there's another book having same title.";
				listBook(message); return; 
			}*/
			
			readBookFields(existbook);                           //create readBookField() and call all the values here
