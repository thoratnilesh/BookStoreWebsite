...
public class CustomerServices {
	...
	public void createCustomer() throws ServletException, IOException {
		...
		if(existCustomer != null) {
			String message = "Could not create new customer: the email " + email + " is already register by another customer.";
			listCustomer(message);
		}
		else {
			
			Customer newCustomer = new Customer();
			updateCustomerFieldsFromForm(newCustomer);                                //call method
	...
	public void registerCustomer() throws ServletException, IOException {
		...
		if(existCustomer != null) {
			message = "Could not cregister. The email " + email + " is already register by another customer.";
	...
	public void updateCustomer() throws ServletException, IOException {
		...
		if(customerByEmail != null && customerByEmail.getCustomerId() != customerId) {
			message = "Could not update customer ID " + " because there's and existing havig same email";
		}
		else {
	...
	public void doLogin() throws ServletException, IOException {
		...
		if(customer == null) {
			String message = "Login Failed. Please enter valid email or password";
			request.setAttribute("message", message);
			showLogin();
		}
		else {
